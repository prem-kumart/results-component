...
const Result = () => {
  return (
    <section className="desktop:w-[386px] desktop:h-[512px] w-[376px] h-[376px] gradient-one rounded-[2rem] flex flex-col justify-center items-center gap-6 pt-8 desktop:pb-20 pb-4">
            <h1 className="font-hanken font-semibold text-light-blue text-2xl tracking-wide">Your Result</h1>
